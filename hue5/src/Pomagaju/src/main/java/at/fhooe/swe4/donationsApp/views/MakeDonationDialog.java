...
public class MakeDonationDialog {
  ...
  public MakeDonationDialog(Window owner, DemandItem demandItem, DonationsScene ownerScene, Model model) {
  ...
  private void makeDonationDialog() {
    ...
    controller = new MakeDonationDialogController(this, model);
  }
