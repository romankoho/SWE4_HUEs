...
public interface Database extends Remote {
    ...
    void addDemand(DemandItem d) throws RemoteException;
    ...
    void addDonation(Donation d) throws RemoteException;
    List<Article> getArticles() throws RemoteException;
    void addArticle(Article a) throws RemoteException;
    ...
    void addOffice(ReceivingOffice o) throws RemoteException;
    ...
    void addUser(String key, User user) throws RemoteException;
