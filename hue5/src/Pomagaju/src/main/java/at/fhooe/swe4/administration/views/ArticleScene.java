...
public class ArticleScene {
  ...
  public ArticleScene(Stage window, Model model) throws RemoteException {
    this.window = window;

    articlesPane = new VBox();
    articlesPane.getChildren().add(Utilities.createMenuBar(window, model));
    ...
    controller = new ArticleSceneController(this, model);
  }
