...
public class DemandScene {
  ...
  public Label getActiveOffice(){return activeOffice;}

  public DemandScene(Stage window, Model model) throws RemoteException {
    this.window = window;

    mainPane = new VBox();
    mainPane.getChildren().add(Utilities.createMenuBar(window, model));
    ...
    controller = new DemandSceneController(this, model);
  }
